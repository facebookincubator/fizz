...
#include <fizz/crypto/experimental/hacl/Hacl.h>
...
std::unique_ptr<Aead> getCipher(const CipherParams& params) {
  ...
  switch (params.cipher) {
    case CipherSuite::TLS_AES_128_GCM_SHA256:
      cipher = std::make_unique<hacl::Hacl>();
      break;
    default:
...
void callDecrypt(
  ...
  try {
    ...
    EXPECT_FALSE(params.valid) << e.what();
  }
}
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        CipherParams{"87f6c12b1ae8a9b7efafc65af0f5c994",
        ...
        CipherParams{
            ...
            true,
            CipherSuite::TLS_AES_128_GCM_SHA256},
        CipherParams{"a0f49e7076cae6eb25ca23a2da0eaf12",
        ...
        CipherParams{"a0f49e7076cbe6eb25ca23a2da0eaf12",
                     "3485d33f22128dff91e47062",
                     0,
                     "",
                     "41424344454617",
